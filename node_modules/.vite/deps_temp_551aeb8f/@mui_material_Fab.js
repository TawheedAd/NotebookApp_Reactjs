...
var _excluded10 = ["children", "className", "color", "component", "disabled", "disableFocusRipple", "focusVisibleClassName", "size", "variant"];
...
var Fab = React24.forwardRef(function Fab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsx)(FabRoot, _extends({
    className: clsx_default(classes.root, className),
    component,
    disabled,
